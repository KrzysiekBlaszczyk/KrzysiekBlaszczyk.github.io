$(document).ready(function() {
    const apiRoot = 'https://kodillaapi-prod-kodilla-tasks-3vwreu.mo1.mogenius.io/v1/tasks';
    const trelloApiRoot = 'https://kodillaapi-prod-kodilla-tasks-3vwreu.mo1.mogenius.io/v1/trello';
